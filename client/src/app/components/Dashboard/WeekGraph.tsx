...
const WeekGraph: React.FC = () => {
  return (
    <section>
      ...
      <div className="flex gap-x-3 justify-center items-end self-center mt-9 max-w-full rounded-md border border-solid border-neutral-400 min-h-[116px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
